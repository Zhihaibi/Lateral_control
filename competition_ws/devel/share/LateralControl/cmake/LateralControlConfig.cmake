...
if(NOT "/home/alan/competition_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'LateralControl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alan/competition_ws/src/LateralControl/${idir}'.  ${_report}")
    endif()
